...
približno 250 let pred Dürerjevim časom. % sklic: 
...
180 stopinj okrog središča, kvadrat iz tabele \ref{table:mag3} je mogoče dobiti
...
\begin{table}[htp]
   ...
   \begin{tabular}{ccccccc}
       \toprule
       \multicolumn{5}{c}{točna vrednost} & \multicolumn{2}{c}{približek} \\ \midrule
